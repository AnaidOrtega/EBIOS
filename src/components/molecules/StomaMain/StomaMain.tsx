...
import Stoma2 from '../../../assets/svg/StomaMain/0001.svg';
import Stoma1 from '../../../assets/svg/StomaMain/0002.svg';

export const StomaMain: FC<{}> = props => {
  ...
  return (
    <ScrollView style={{backgroundColor: 'white'}}>
      ...
      <Footer url={'http://161.35.105.244/ficha/stoma.pdf'} />
    </ScrollView>
  );
};
