      ...
      <View style={styles.container}>
        ...
        <View style={styles.redFrame}>
          <Text style={{textAlign: 'justify'}}>
            ...
            {'\n'}● Mantiene productiva el área foliar y orienta la descarga de
            azúcares a la “piña”.
          </Text>
        </View>
        <ColorBar />
        <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
          <Text style={{textAlign: 'justify'}}>
            ...
            {'\n'}
            {'\n'}• Para disminuir el impacto oxidativo de la alta temperatura y
            de las lluvias irregulares, esto es, retrasar la senescencia del
            cultivo de agave.{' '}
            <Text style={{textAlign: 'justify', fontWeight: 'bold'}}>
              De abril a septiembre aplicar 2.5 ml / L de agua cada mes.
            </Text>
            {'\n'}
            {'\n'}• Para aumentar la actividad metabólica en los meses de frío y
            sequía.{' '}
            <Text style={{textAlign: 'justify', fontWeight: 'bold'}}>
