      ...
      <View style={styles.container}>
        ...
        <View style={styles.redFrame}>
          <Text style={{textAlign: 'justify'}}>
            ...
            {'\n'}● Mayor capacidad de carga floral de los “dardos” vegetativos.
            {'\n'}
        ...
        <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
          <Text style={{textAlign: 'justify'}}>
            ...
            aplicación con la misma dosis. {'\n'}• Para favorecer el cuajado de
            frutos: 1 L al inicio de flor abierta y repetir cada 15 días hasta
            30 días después de antesis (proceso de fecundación del óvulo).{' '}
            {'\n'}• Para favorecer el tamaño de los frutos, firmeza y vida de
            anaquel: 1 L a los 25 días después de antesis, iniciar las
