      ...
      <View style={styles.container}>
        ...
        <View style={styles.redFrame}>
          <Text style={{textAlign: 'justify'}}>
            ...
            menos 1 décima.{'\n'}
            {'\n'}● Disminuye el impacto negativo de la baja temperatura: falta
            de grado, menor largo de dedo y baja conversión.{'\n'}
        ...
        <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
          <Text style={{textAlign: 'justify'}}>
            ...
            conversión y calidad del racimo para la cosecha del primer semestre
            del año.
          </Text>
        </View>
        <EBios style={{width: 120, height: 120}} />
