      ...
      <View style={styles.container}>
        ...
        <View style={styles.redFrame}>
          <Text style={{textAlign: 'justify', fontSize: textSize}}>
            ...
            {'\n'}• Disminución de disturbios fisiológicos asociados a la sobre
            maduración (dientes cerosos - waxy breakdown) • Mayor concentración
            de alicina, betacaroteno y otros compuestos antioxidantes lo cual
        ...
        <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
          <Text style={{textAlign: 'justify'}}>
            ...
            bulbo y las 3 siguientes aplicaciones de 10 a 15 días después de la
            inmediata anterior.
          </Text>
        </View>
        <EBios style={{width: 120, height: 120}} />
