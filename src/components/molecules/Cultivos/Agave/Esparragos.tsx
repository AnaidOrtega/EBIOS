...
export const Esparragos: FC<{}> = props => {
      ...
      <View style={styles.container}>
        ...
        <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
          <Text style={{textAlign: 'justify'}}>
            ...
            {'\n'}
            {'\n'}500 ml en pleno crecimiento vegetativo, repetir la aplicación
            cuando se inicie la descarga de carbohidra- tos a la corona ( de
            esta realizar 2 aplicaciones antes del desvare).
          </Text>
        </View>
        <EBios style={{width: 120, height: 120}} />
        <Footer
