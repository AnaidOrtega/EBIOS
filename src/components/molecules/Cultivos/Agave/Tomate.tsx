      ...
      <View style={styles.container}>
        ...
        <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
          <Text style={{textAlign: 'justify'}}>
            ...
            {'\n'}
            {'\n'}• Tomates indeterminados iniciar las aplicaciones del 5to. al
            6to. racimo a dosis de 1/2 L por Ha, cada 15 días y después de cada
            corte. {'\n'}• Tomates determinados iniciar las aplicaciones al
            iniciar el segundo set de floración a dosis 1/2 L por Ha, cada 10
            días y después de cada corte.{' '}
          </Text>
        </View>
        <EBios style={{width: 120, height: 120}} />
        <Footer
